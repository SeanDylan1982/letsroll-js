...
module.exports = ({ cardings }) => {
  const renderedCardings = `
        <div class="cardings-container" id="cardings-container">
          <img src="./img/cardings.png" alt="cardings logo" id="cardings-img">
          <div class="disclaimer" id="cardings-disclaimer">
            <div class="cardings-intro" id="cardings-intro">
              <h2>Cardings</h2>
